...
"#;
    ...
    fn test_contract_persisted_with_row_count_and_stream() {
        ...
        // (c2) Phase 3: the producing statement carries a byte range that slices its own
        // source out of sql_text.
        ...
        // (c3) Phase 3: an executed step records ≥1 attempt and a wall-clock duration.
        ...
        // Fields still deferred beyond this phase stay null.
